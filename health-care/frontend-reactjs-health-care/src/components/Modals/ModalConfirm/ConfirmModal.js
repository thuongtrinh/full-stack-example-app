...
class ConfirmModal extends Component {
  ...
  onAcceptBtnClick = () => {
    ...
    console.log(contentOfConfirmModal);
  ...
  render() {
    ...
    return (
      <Modal
        ...
        className="confirm-modal custom-base"
        centered={true}
      >
        <div className="modal-header">
          ...
          <button className="btn btn-close" onClick={this.onClose}></button>
        </div>
            ...
            <div className="row">
              ...
              <div className="col-12">
                <div className="btn-container text-center">
                  <button
                    className="btn btn-add btn-close-modal"
