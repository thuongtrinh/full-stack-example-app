...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", basePackages = {"com.txt.rest.health.care.repository"})
@EntityScan(basePackages = {"com.txt.rest.health.care"}, basePackageClasses = {Jsr310JpaConverters.class})
public class PostgresDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder, @Qualifier("dataSource") DataSource dataSource) {
        LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean = builder.dataSource(dataSource)
                .persistenceUnit("eUnit").build();
        localContainerEntityManagerFactoryBean.setJpaVendorAdapter(jpaVendorAdapter());
        localContainerEntityManagerFactoryBean.setPackagesToScan("com.txt.rest.health.care");
