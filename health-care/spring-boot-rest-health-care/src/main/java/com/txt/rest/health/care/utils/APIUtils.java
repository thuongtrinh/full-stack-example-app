package com.txt.rest.health.care.utils;

import com.txt.rest.health.care.dto.common.APIStandardResponseDTO;
import com.txt.rest.health.care.dto.common.Error;
import com.txt.rest.health.care.dto.common.ResponseCode;
import com.txt.rest.health.care.dto.common.ResponseStatus;
...
public class APIUtils {
    ...
    public static <T> APIStandardResponseDTO<T> statusError(String code, String message) {
        APIStandardResponseDTO<T> PVAStandardResponseDTO = new APIStandardResponseDTO<>();
        PVAStandardResponseDTO.setStatus("FAILED");
    ...
    public static <T> APIStandardResponseDTO<T> statusError(String code, String message, List<Error> errors) {
        APIStandardResponseDTO<T> PVAStandardResponseDTO = new APIStandardResponseDTO<>();
        PVAStandardResponseDTO.setStatus("FAILED");
        PVAStandardResponseDTO.setResponseStatus(ResponseStatus.builder().code(code).message(message).errors(errors).build());
        return PVAStandardResponseDTO;
    }
